...
/*---------------------------------------------------------------*/
class GUINotifEvent:public GUIMazeEvent
{
public:
    virtual eMaze_Event GetEventID(){return EV_GUI_NOTIF;}
    GUINotifEvent(){m_Notif = SEARCH_COMPLETED;}

    eNotif GetNotif(){return m_Notif;}
    void SetNotif(eNotif notif){ m_Notif = notif;}
